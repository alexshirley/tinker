...
uint32_t dsp_ring_count(dsp_ring_t* __restrict c);
bool dsp_ring_push(dsp_ring_t* __restrict c, const void* __restrict pData);
void dsp_ring_clear(dsp_ring_t* __restrict Fifo);
